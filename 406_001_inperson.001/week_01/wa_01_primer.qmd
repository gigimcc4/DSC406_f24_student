...
"Chunks", "block", or "blob" of R code can be added using the insert option from the toolbar or the CTRL + ALT + I shortcut

Or

by adding triple backticks on either side of the code chunk, but now add curly brackets at the end of the first triplet

#### **👉 Your Turn** **⤵**

Add a code chunk with a method of your choice.

# HOLD to ADD image here
